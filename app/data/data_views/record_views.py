...
from ashlar.models import RecordType, BoundaryPolygon, Boundary
from ashlar.views import RecordViewSet
from data.models import RecordAuditLogEntry, RecordCostConfig
...
from driver_auth.permissions import (
...
class DriverRecordViewSet(RecordViewSet, mixins.GenerateViewsetQuery):
    ...
    def _build_ummalqura_sequential_case(self, sequential_ranges, period_type, min_date, max_date):
        ...
        if period['type'] == 'derived':
            ...
            # No source aggregations at the moment
            raise ParseError(
                description='Ummalqura calendar has no source based sequential aggregations'
            )
